...
class ProductApiIntegrationTest {
  ...
  void productCrud() {
    ...
    ProductRequest invalidBrandReq = new ProductRequest("티셔츠", Category.TOPS, 10000, 999L);
    ...
    ProductRequest invalidPriceReq = new ProductRequest("티셔츠", Category.TOPS, -1000, brandId);
    ...
    // 3. 상품 생성 - 성공 케이스
    ProductRequest createReq = new ProductRequest("티셔츠", Category.TOPS, 10000, brandId);
    ...
    // 5. 상품 수정
    ProductRequest updateReq = new ProductRequest("셔츠", Category.TOPS, 12000, brandId);
